...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-screen aspect-video pt-[18%] px-12 absolute bg-gradient-to-r from-black">
      ...
      <div>
        ...
        <button className="mx-2 bg-gray-500 text-black p-4 px-12 text-xl bg-opacity-50 rounded-lg">
          More Info
        </button>
      </div>
    </div>
